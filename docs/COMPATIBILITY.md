...
本地实际执行 PHP 7.4.33 / 8.0.30 / 8.1.34 / 8.2.33 / 8.3.33 / 8.4.25 / 8.5.10，全部使用原生 pdo_sqlite。本版Linux CI为七个PHP小版本各运行原生MySQL8.0与SQLite两组，共14组，分别开/关Fileinfo，共28个状态均通过；准确提交、数量与状态见 TEST_REPORT.md，不把旧报告计入最新改动的通过数。
