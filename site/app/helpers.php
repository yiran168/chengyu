...
function admin_groups(): array
{
    return [
        ...
        'Create and publish'=>['contents','bulletins','learning','search_index','categories','collections','resources','downloads','media','media_lab','translations','moderation'],
