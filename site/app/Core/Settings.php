...
final class Settings
{
    ...
    public function __construct(Database $db, Crypto $crypto)
    {
        ...
        $this->schema = array_merge(require dirname(__DIR__) . '/settings.php', require dirname(__DIR__) . '/settings016.php', require dirname(__DIR__) . '/settings017.php', require dirname(__DIR__) . '/settings018.php', require dirname(__DIR__) . '/settings019.php');
        $this->reload();
    }
