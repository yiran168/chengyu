...
final class VisualAssets
{
    ...
    public const ICONS=['icon-discover'=>'Anime discovery','icon-community'=>'Anime community','icon-shop'=>'Anime shop','icon-member'=>'Anime membership','icon-create'=>'Anime writing','icon-archive'=>'Anime archive'];
