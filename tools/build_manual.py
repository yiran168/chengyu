...
<title>澄屿 0.21.0 · 部署与使用手册</title><style>{css}</style></head>
...
<div class="badges"><span>版本 0.21.0</span><span>更新于 2026-09-13</span><span>非 WordPress</span><span>{len(manual_parts)} 篇说明 · {len(previews)} 张实页预览</span></div></header>
...
<p>新站只上传 <code>site/</code>；已有 0.9.0–0.20.0 先备份，保留配置密钥、数据库与存储，再升级。根目录部署的后台入口为 <code>/admin</code>。</p>
<p class="note"><strong>不要上传完整交付目录或 INSTALL_KEY.txt。</strong> 本包含真实业务代码，但不等于全部历史子比模块已完成，也没有把未测试的 PHP 版本、原生数据库或真实商户标成通过。</p>
<div class="quicklinks"><a href="#chapter-34">0.21 新功能</a><a href="#chapter-35">三主题对照</a><a href="#chapter-33">0.20 模块</a><a href="#chapter-31">0.19 模块</a><a href="#chapter-27">上线验收</a><a href="#chapter-28">历史对照</a><a href="#chapter-22">交易</a><a href="#chapter-23">媒体</a><a href="#chapter-2">新站安装</a><a href="#chapter-3">旧站升级</a><a href="#chapter-5">动效与曲线</a><a href="#chapter-21">连接与运营</a><a href="#chapter-20">安全与定价</a><a href="#chapter-11">缺漏清单</a><a href="#chapter-12">测试证据</a></div></section>
{''.join(articles)}
<article id="previews" class="chapter"><p class="eyebrow">ACTUAL APPLICATION PREVIEWS</p><h2>页面预览与历史记录</h2><p>标记 021 的图片来自本轮实际浏览器，完整交互套件通过 122 项检查；020 及更早图片保留为历史模块预览。页面由本项目临时站点生成并在 Chromium 渲染。点击查看原图，截图来自原创示例数据，不是生产数据或概念海报。</p><div class="gallery">{gallery}</div></article>
</main></div><footer>澄屿 0.21.0 · 本说明与分篇 Markdown 同步生成。离线使用时保持 docs/previews 相对目录不变。代码许可见 LICENSE。</footer></body></html>"""
