...
check('020 admin visual studio lists complete shared icon registry',len(visual20.select('.symbol-grid .visual-tile'))==83 and visual20.select_one('input[name=revision]') is not None)
