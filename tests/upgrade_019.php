...
if($phase==='seed'){
    if(!in_array(\Chengyu\App::VERSION,['0.18.0','0.19.0','0.20.0','0.21.0','0.22.0'],true)){throw new RuntimeException('Supply an original 0.18–0.22 site directory.');}
    ...
    $resource=0;if(in_array(\Chengyu\App::VERSION,['0.19.0','0.20.0','0.21.0','0.22.0'],true)){$resource=$a->resources->save($actor,['content_id'=>$item,'label'=>'Preserved edition','mirror_url'=>'https://downloads.example.test/keep','active'=>1]);}
